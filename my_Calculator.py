...
def edited_by():
    tmsg.showinfo('Terms of Use ',' TUSHAR,PRAFUL,KEDAR,SACHIN,SARTHAK.')

def send_feedback():
    ans=tmsg.askquestion('Feedback Hub','Was your experience good with us ? ')
    if ans=='yes':
        tmsg.showinfo('Feedback','Please Rate us on DYPCOE website.')
    else:
        tmsg.showinfo('Feedback','Our team will look forward for your bad experience')
...
m1.add_command(label='Edited by',command=edited_by)
